              ...
              <div className="relative z-10 text-blue">
                ...
                <div className="mb-16">
                  ...
                  <div className="space-y-4 text-default">
                    ...
                    <p className="text-sm tracking-wider leading-relaxed text-orange font-bold">NOTE: Thurs 6/19 is a Market Holiday in the U.S. for Juneteenth <span className="text-xs font-normal block mt-1">Many companies have the day off.</span></p>
